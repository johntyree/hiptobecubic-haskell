...
if executable("runhugs")
  " exec 'setlocal makeprg=runhugs\ -98\ %\ >\ /dev/null'
  exec 'setlocal makeprg=echo\ ":q" \\\| hugs\ -98\ %'
  let g:haskell_path = ""
endif
...
"
" This is broken right now... maybe someday
finish
...
map _i 0/[A-Z]/<CR>:noh<CR>"bye:call Browse(@b)<CR>$a (^M )^["bP:call Format()<CR>
map _B :call Browse("")<CR>:call New()<CR>"bP
map _b :call Browse("")<CR>1GO{-^M-}^M^[1G"bp
